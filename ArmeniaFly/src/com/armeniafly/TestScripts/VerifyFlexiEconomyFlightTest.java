...
public class VerifyFlexiEconomyFlightTest extends Base
{
    @Test
    public void verifyFlexiEconomyFlight() throws InterruptedException
    {
        try {
            ...
            FlexiEconomyFlight flexi = new FlexiEconomyFlight(driver);
            ...
            String actualEconomyType = flexi.getFlexiText();
            String expectedEconomyType = "Flexi";
            Assert.assertEquals(actualEconomyType, expectedEconomyType);

            String actualFlexiPrice = flexi.getFlexiPrice();
            String expectedFlexiPrice = "84 036 ֏";
            Assert.assertEquals(actualFlexiPrice, expectedFlexiPrice);
