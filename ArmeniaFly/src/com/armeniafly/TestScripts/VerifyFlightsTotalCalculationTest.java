...
public class VerifyFlightsTotalCalculationTest extends Base
{
    @Test
    public void verifyFlightsTotalCalculation()
    {
        try
        {
            ...
            FlightsTotalCalculation calculation = new FlightsTotalCalculation(driver);
            ...
            premium.selectPremiumFlight();


            String actualTotal = calculation.getFlightsTotal();
            String expectedTotal = "264 073 ֏";
