...
public class VerifyModifySearchTest extends Base
{
    @Test
    public void verifyModifySearch() throws InterruptedException
    {
        try {
            ...
            wait4.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(@class,'_2jaoq _1PeWh')]")));

            modifySearch.clickPassenger();

            WebDriverWait wait5 = new WebDriverWait(driver, Duration.ofSeconds(20));
            wait5.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(@class,'_1Gu5m _2B2Xy')]")));

            modifySearch.addPassenger();
