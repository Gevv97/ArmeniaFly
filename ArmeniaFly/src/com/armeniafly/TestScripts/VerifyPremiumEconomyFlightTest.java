...
public class VerifyPremiumEconomyFlightTest extends Base
{

    @Test
    public void verifyPremiumEconomyFlight() throws InterruptedException
    {
        try {
            ...
            StandardEconomyFlight standard = new StandardEconomyFlight(driver);
            PremiumEconomyFlight premium = new PremiumEconomyFlight(driver);
            ...
            economy.selectStandard();

            standard.returnFlightButton();

            economy.selectPremium();

            String actualEconomyType = premium.getPremiumText();
            String expectedEconomyType = "Premium";
            Assert.assertEquals(actualEconomyType, expectedEconomyType);

            String actualPremiumPrice = premium.getPremiumPrice();
            String expectedPremiumPrice = "180 037 ֏";
            Assert.assertEquals(actualPremiumPrice, expectedPremiumPrice);
