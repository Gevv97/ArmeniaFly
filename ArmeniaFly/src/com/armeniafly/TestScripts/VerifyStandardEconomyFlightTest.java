...
import com.armeniafly.Pages.StandardEconomyFlight;
...
public class VerifyStandardEconomyFlightTest extends Base
{
    @Test
    public void verifyStandardEconomyFlight() throws InterruptedException
    {
        try {
            ...
            String actualEconomyType = standard.getStandardText();
            String expectedEconomyType = "Standard";
            Assert.assertEquals(actualEconomyType, expectedEconomyType);

            String actualStandardPrice = standard.getStandardPrice();
            String expectedStandardPrice = "72 166 ֏";
            Assert.assertEquals(actualStandardPrice, expectedStandardPrice);
        }
        catch(Exception ex)
        {
